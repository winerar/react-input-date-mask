...
const ReactInputDateMask = ({
    ...
    const checkOneValue = (val, valueString, position) => {
        const regex = {
            ...
            Д: /([0-3]Д)|(0[1-9]|[12][0-9]|3[01])|(Д[0-9])/,
            М: /([0-1]М)|(0[1-9]|1[012])|(М[0-2])/,
            Г: /([1-2]ГГГ)|((19|20)ГГ)|((19|20)\dГ)|((19|20)\d\d)|(Г{2,3}\d{1,2})|(ГГ\dГ)|([1-2]Г\d{1,2})/,
            '/': /\//,
            '.': /\./
        };
